    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="<?= base_url(); ?>conta/exibir/<?= $this->session->id; ?>" rel="tooltip" title="Plataforma de pesquisas compartilhadas" data-placement="bottom">
                    Bem Vindo ao ULWAZI
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="<?= base_url(); ?>/theme/assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="<?= base_url(); ?>p_conta">
