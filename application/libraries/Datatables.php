  ...
  class Datatables
  {
    ...
    */
    private function produce_output($output, $charset)
    {
      ...
      if($output == 'json')
      {
        //Devido a grande quantidade de registros na tabela decidi setar as variáveis abaixo como 0;
        //Para melhorar o Debug será melhor usar  o tatal de registros para retornados com o limit passado
        $iTotal =  0;//$this->get_total_results();
        $iFilteredTotal = 0;//$this->get_total_results(TRUE);
